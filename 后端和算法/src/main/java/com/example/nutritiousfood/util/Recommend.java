package com.example.nutritiousfood.util;
...
public class Recommend {
     ...
     * @return
     */
    public List<Integer> chuli(List<UserR> userRList, UserR userR) {
     ...
     * @return 二值化处理之后的结果
     */
    public List<UserR> jisuan(UserR userR, List<UserR> userRS) {
